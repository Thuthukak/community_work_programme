...
class ComposerAutoloaderInit846c0d5b03a8d09ff62b6bc630aa979f
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit846c0d5b03a8d09ff62b6bc630aa979f::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire846c0d5b03a8d09ff62b6bc630aa979f($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire846c0d5b03a8d09ff62b6bc630aa979f($fileIdentifier, $file)
{
