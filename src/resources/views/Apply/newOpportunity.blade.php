<!-- Apply Modal -->
<div class="modal fade" id="newOpportunityModal" tabindex="-1" role="dialog" aria-labelledby="newOpportunityModalLabel" aria-hidden="true">
    ...
    <form action="{{ route('opportunity.store') }}" method="post">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                <button class=" btn btn-dark" type="submit">Post Opportunity</button>
                            </div>
