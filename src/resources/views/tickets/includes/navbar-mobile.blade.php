    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid d-flex justify-content-between align-items-center">   
            ...
            <div class="d-flex align-items-center">
                @guest
                <a class="nav-link border-2 rounded text-white " href="javascript:void(0);" data-toggle="modal" data-target="#registerModal">{{ __('theme.register') }}</a>
                @else
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu custom-dw" aria-labelledby="navbarDropdown">
        ...
        <div class="collapse navbar-collapse " id="navbarNav">
            ...
            @guest
                <li class="nav-item ">               
                    <button class="nav-link p-2 nl-border text-white" href="javascript:void(0);" data-toggle="modal" data-target="#loginModal">{{ __('theme.login') }}</button>
                </li>
                @else
