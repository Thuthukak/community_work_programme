    ...
    @include('crm.tickets.addTicket')
        ...
        <div class="row">
            <div class="col-md-5 col-12 text-center text-md-left" data-aos="fade-down" data-aos-offset="200" data-aos-delay="20" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-mirror="true">
                ...
                <a href="javascript:void(0)" class="btn btn-primary mt-3 mb-3 md:mb-0" data-toggle="modal" data-target="#addTicketModal">
                    <i class="fa fa-ticket" aria-hidden="true"></i> {{ __('theme.submit_ticket') }}
                </a>
