...
return array_merge(
    [
       ...
       // invoice
        ...
        'email_setting_is_not_correct' => 'Email setting is not correct!',
        ...
        'choose_a_tax' => 'Choose a tax',
        'tax_already_in_use' => 'Tax already in used. You cannot update or delete this tax.',

        //tag
        'enter_tag_name' => 'Enter tag name',
        'color_code' => 'Color code',
        'tag_already_in_use' => 'Tag already in use',
        'user_create' => 'User created',
        'attachment' => 'Attachment',


        //area_of_expenses
        'area_of_expenses' => 'Area of expenses',
        'add_expense_area' => 'Add expense area',
        'add_area_of_expense' => 'Add area of expense',
        'edit_expense_area' => 'Edit expense area',
        'expenses' => 'Expenses',
        'add_expense' => 'Add expense',
        'edit_expense' => 'Edit expense',
        'total_expense_in_this_area' => 'Total expense in this area',
        'expense_attachment_allowed_file_types' => 'Allowed file types: jpeg, jpg, gif, png, pdf, zip. (Max file size is 2MB)',
