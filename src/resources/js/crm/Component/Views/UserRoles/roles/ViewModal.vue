        ...
        <template slot="body">
            ...
            <template v-if="role.name === 'Agent'">
               ...
               <p>Agent have the following permissions:</p>
                ...
                <ol>
                    ...
                    <li> Can add leads person and Organization (manage his/her own created person and Organization).
                    </li>
                    ...
                    <li>Can create activities within his/her own person, Organizations and deals.</li>
                </ol>
            ...
            <template v-if="role.name === 'Client'">
                <p>
                    ...
                    Leads by inviting as "Client" users from the <b>Leads (Person)</b> module action.
                </p>
                <p>
