            ...
            <div
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        <a href="https://pipex.gainhq.com/documentation/change-log.html"
            ...
            axios.get(this.getAppUrl('app/v2/manual-update/generate-download-file-url'))
                .then(({data}) => {
                    ...
                    fetch(downloadUrl, {}).then(res => {
                        const headerName = Object.assign({}, [...res.headers].filter(item => item[0]==='filename'));
                        return res.blob().then((data) => {
                            return {
                                data: data,
                                filename: headerName[0][1],
                                response: res,
                            };
                        });
                    }).then((response) => {
                        ...
                        a.href = url;
                        a.download = response.filename+".zip";
