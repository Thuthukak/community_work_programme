<template>
    ...
    >
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <a class="align-self-center d-lg-none pl-0 navbar-brand" href>
                <img :src="`${configData ? configData : '/images/core.png'}`" alt="logo"/>
            </a>
            <button
        ...
        >
          ...
          <app-icon :name="'align-justify'"/>
            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
                <li v-if="marketPlaceVersion" class="nav-item mr-4">
                    <a
                        class="btn btn-outline-secondary"
                        href="https://codecanyon.net/item/pipex-crm/29361195"
                        target="_new"
                    >
                        <span>Buy Now</span>
            ...
            <span v-if="darkMode" :key="'sun'">
              ...
              <app-icon :name="'moon'"/>
                ...
                <app-navbar-profile-dropdown :data="profileData" :user="user"/>
            </ul>
        </div>
    </nav>
</template>
