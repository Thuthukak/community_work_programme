...
Vue.component(
    "app-lead-web-form-setting",
    require("./Component/Views/Contacts/Person/LeadWebFormSetting").default
);
Vue.component(
    "app-person-modal",
...
Vue.component(
    "app-common-person",
    require("./Component/Helpers/DataTable/CommonPeronColumn").default
);
Vue.component(
    "all-person-org",
...
Vue.component(
    ...
    require("./Component/Helpers/Proposal/DetailsProposal").default
);

Vue.component(
    "app-common-all-proposals",
    require("./Component/Helpers/ViewAllProposalsModal").default
);
...
Vue.component('tags-column',
    require("./Component/Helpers/DataTable/TagsColumn").default);
...
Vue.component(
    ...
    require("./Component/Views/UserRoles/UserCreateModal").default
);
...
Vue.component(
    "activity-details-from-related-to",
    require("./Component/Views/Activities/ActivityDetailsFromRelatedTo").default
);
...
Vue.component(
    "app-cron-job-settings",
    require("./Component/Views/Settings/CronJobSettings").default
);
Vue.component(
...
Vue.component(
    "app-tag",
    require("./Component/Views/Settings/Tag").default
);

Vue.component(
    "app-tax",
    require("./Component/Views/Settings/Tax").default
);

Vue.component(
    "app-tag-modal",
    require("./Component/Views/Settings/TagModal").default
);

Vue.component(
    "app-tax-modal",
    require("./Component/Views/Settings/TaxModal").default
);
...
Vue.component(
    "app-test-mail-modal",
    require("./Component/Views/Settings/TestMailModal").default
);
...
Vue.component('lead-bulk-action', require('./Component/Views/Contacts/BulkAction/LeadBulkAction').default);
Vue.component('person-organization-modal', require('./Component/Views/Contacts/BulkAction/PersonOrganizationModal').default);
...
Vue.component(
    'reports-invoice',
    require("./Component/Views/Reports/Invoice/ReportInvoice").default
);
Vue.component(
    "app-invoice-modal",
    require("./Component/Views/Invoice/InvoiceModal").default
);
Vue.component(
    "app-invoice-status-modal",
    require("./Component/Views/Invoice/InvoiceStatusModal").default
);
Vue.component(
    "app-deal-person-send-invoice",
    require("./Component/Views/Invoice/SendInvoiceModal").default
);

//Area of expense
Vue.component(
    'area-of-expenses',
    require("./Component/Views/Expense/AreaOfExpense").default
);
Vue.component(
    "app-expense-area-modal",
    require("./Component/Views/Expense/ExpenseAreaModal").default
);

//Expense
Vue.component(
    "expenses",
    require("./Component/Views/Expense/Expense").default
);

Vue.component(
    "expense-create-edit-modal",
    require("./Component/Views/Expense/ExpenseCreateEditModal").default
);
Vue.component(
...
/*Update*/
Vue.component('app-update', require('./Component/Views/Update/Update').default);
Vue.component('app-manual-updater', require('./Component/Views/Update/ManualUpdater').default);
Vue.component('app-update-confirmation-modal', require('./Component/Views/Update/UpdateConfirmationModal').default);


// registering an invoice-setting component
Vue.component('invoice-settings', require('./Component/Views/Settings/InvoiceSettings').default);

// Email
Vue.component('email-inbox', require("./Component/Views/Email/Inbox").default);
Vue.component('email-compose', require("./Component/Views/Email/Compose").default);

// // webform
Vue.component('lead-web-form', require("./Component/Views/Lead/Webform").default);
