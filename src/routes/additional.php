...
use App\Http\Controllers\CRM\CronJobSettingController;
use App\Http\Controllers\Core\Frontend\TableFilterController;
use App\Http\Controllers\Core\LanguageController;
use App\Http\Controllers\CRM\TestMailController;
...
Route::group(['prefix' => 'app'], function () {
    ...
    Route::get('settings/cronjob', [CronJobSettingController::class, 'index'])->name('cron-job-settings');
