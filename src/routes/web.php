...
//okr routes
        ...
        Route::get('calendar', [ActivityController::class ,'calendar'])->name('calendar.index');
        Route::post('calendar/user/{user}/create', [ActivityController::class , 'create'])->name('calendar.create');
        Route::get('calendar/activity/{activity}/show', [ActivityController::class , 'show'])->name('calendar.show');
        Route::patch('calendar/activity/{activity}/update', [ActivityController::class , 'update'])->name('calendar.update');
        Route::delete('calendar/activity/{activity}/destroy', [ActivityController::class ,'destroy'])->name('calendar.destroy');
        // Get iCal format
        Route::get("ical-events", [IcalendarController::class , 'getEventsICalObject'])->name('calendar.ical');
    ...
    //view list okrs 
    Route::get('Objectives/', [OkrController::class ,'listOKR'])->name('okr.list');
...
Route::get('organization/department/{department}', [DepartmentController::class ,'index'])->name('department.index');
// Save new department
Route::post('organization/department/store', [DepartmentController::class , 'store'])->name('department.store');
// Edit department page
Route::get('organization/department/{department}/edit', [DepartmentController::class ,'edit'])->name('department.edit');
// Update department
Route::patch('organization/department/{department}/update', [DepartmentController::class , 'update'])->name('department.update');
// Delete department
