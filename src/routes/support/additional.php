...
Route::delete('activities/file-destroy/{file}', [AdditionalController::class, 'fileDestroy'])
    ->name('activities.file-destroy');

// All User

Route::get('auth/users', [AppUserController::class, 'crmAuthUsers'])->name('crm.auth_user');

Route::post('user/create', [AppUserController::class, 'createUser'])->name('user.create');

//get agent
Route::get('auth/agent', [AppUserController::class, 'crmLoggedAgentUser'])->name('crm.logged_agent_user');
...
Route::post(
    'person/{person}/send-email',
    [PersonController::class, 'sendEmailToPerson']
)->name('person.send_email');
...
Route::get('organizations/{organization}/persons', [OrganizationFollowerController::class, 'organizationPersons'])
    ->name('organizations.get-person');
...
Route::get('getOrganizations', [OrganizationController::class, 'searchOrganizationLists'])
    ->name('organization_list_search');

Route::get('getTags', [TagController::class, 'searchTagLists'])
    ->name('tag_list_search');
...
Route::delete('system/user-delete/{user}', [AppUserRoleController::class, 'userDelete'])
