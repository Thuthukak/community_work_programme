                ...
                <div id="imageCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset($publicPath.'/images/banner/banner1.jpg') }}" class="d-block w-100 img-fluid" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset($publicPath.'/images/banner/banner2.jpg') }}" class="d-block w-100 img-fluid" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset($publicPath.'/images/banner/banner3.jpg') }}" class="d-block w-100 img-fluid" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset($publicPath.'/images/banner/banner4.jpg') }}" class="d-block w-100 img-fluid" alt="Image 4">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset($publicPath.'/images/banner/banner5.jpg') }}" class="d-block w-100 img-fluid" alt="Image 5">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset($publicPath.'/images/banner/banner6.jpg') }}" class="d-block w-100 img-fluid" alt="Image 6">
                        </div>
                    </div>
