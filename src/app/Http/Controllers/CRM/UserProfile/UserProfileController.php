...
namespace App\Http\Controllers\CRM\UserProfile;
...
class UserProfileController extends Controller
{
    ...
    public function resume(Request $request){
        ...
        try{
            ...
            $oldResume = UserProfile::where('user_id', $user_id)->value('resume');
    ...
    public function avatar(Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            ...
            $oldAvatar = UserProfile::where('user_id', $user_id)->value('avatar');
