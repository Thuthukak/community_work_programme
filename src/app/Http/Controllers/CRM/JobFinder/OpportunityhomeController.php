...
namespace App\Http\Controllers\CRM\JobFinder;
...
class OpportunityhomeController extends Controller
{
    ...
    public function jobTrash(){
        $jobs = Opportunity::onlyTrashed()->get();
       return view('admin.jobs.trash', compact('jobs'));
   }

    // Job Restore method 
    public function jobRestore($id){
        Opportunity::onlyTrashed()->where('id', $id)->restore();
    ...
    public function jobDeletePermanantly(Request $request){
        ...
        $id = $request->get('id');
        Opportunity::onlyTrashed()->where('id', $id)->forceDelete();
    ...
    public function getAllCategory(){
        $categories = OpportunityCategorie::latest()->get();
    ...
    public function editCategory($id){
        $category = OpportunityCategorie::findOrFail($id);
    ...
    public function updateCategory(Request $request, $id){
        ...
        OpportunityCategorie::where('id', $id)->update([
    ...
    public function destroyCategory(Request $request, string $id){
        $Category = OpportunityCategorie::find($id);
        $Category->delete();
    ...
    public function categoryToggle($id){
        $categoryToggle = OpportunityCategorie::find($id);
    ...
    public function readPost($id){
        ...
        $featured = Opportunity::where('featured', 1)->get();
    ...
    public function updatePost(Request $request, $id){
        ...
        try{
            ...
            if ($request->hasFile('post_thumbnail')) {
                ...
                $oldThumb = JobPost::where('id', $id)->value('post_thumbnail');
    ...
    public function postTrash(){
         $posts = JobPost::onlyTrashed()->get();
        return view('admin.posts.trash', compact('posts'));
    }

    // Post Restore method 
    public function postRestore($id){
         JobPost::onlyTrashed()->where('id', $id)->restore();
    ...
    public function postDeletePermanantly(Request $request){
        ...
        // Retrieve the old Cv filename
        $oldThumb = JobPost::onlyTrashed()->where('id', $id)->value('post_thumbnail');
        ...
        JobPost::onlyTrashed()->where('id', $id)->forceDelete();
