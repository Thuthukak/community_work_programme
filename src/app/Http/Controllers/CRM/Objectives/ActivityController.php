...
class ActivityController extends Controller
{
    ...
    public function objectives(User $user)
    {
        $action = array();
        $actions = array();
        $colors = ['App\Models\Core\Auth\User' => '#e87461', 'App\Project' => '#e0c879', 'App\Company' => '#0072e3', 'App\Department' => '#00aeae'];
        $blade = ['App\Models\Core\Auth\User' => '個人目標', 'App\Project' => '個人專案', 'App\Company' => '公司目標', 'App\Department' => '部門目標'];
