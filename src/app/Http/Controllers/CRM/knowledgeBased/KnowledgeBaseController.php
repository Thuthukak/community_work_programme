...
namespace App\Http\Controllers\CRM\knowledgeBased;

use App\Models\CRM\Departments\Department;
use App\Models\CRM\KnowledgeBased\KnowledgeBase;
...
class KnowledgeBaseController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return DataTables::of($data)
                ...
                ->addColumn('pinned_status', function ($data){
                    ...
                    if($data->status == 0){
                        return '<span class="badge badge-warning">'.__('theme.unpublished').'</span>';
                    }else{
                        return '<span class="badge badge-success">'.__("theme.published").'</span>';
                    }
                })
    ...
    public function KnowledgeBaseIndex()
    {
        ...
        return view('crm.knowledgebase.department', compact('catgegories','posts','gs'));
    }
